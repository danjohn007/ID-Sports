...
class App {
    ...
    private function route($url) {
        $routes = [
            ...
            'reservations/autoComplete' => ['ReservationController', 'autoComplete'],
            ...
            'config/sports'              => ['ConfigController', 'sports'],
            'config/upload-sport-image'  => ['ConfigController', 'uploadSportImage'],
